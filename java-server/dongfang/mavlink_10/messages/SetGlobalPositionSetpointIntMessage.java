...
public class SetGlobalPositionSetpointIntMessage extends MavlinkMessage {
  ...
  public SetGlobalPositionSetpointIntMessage(int sequence, int systemId, int componentId) {
    super(sequence, systemId, componentId);
  }

  public int getId() { return 53; }

  public String getDescription() { return "Set the current global position setpoint."; }

  public int getExtraCRC() { return 33; }
  ...
  public String toString() {
    StringBuilder result = new StringBuilder("SET_GLOBAL_POSITION_SETPOINT_INT");
    result.append(": ");
