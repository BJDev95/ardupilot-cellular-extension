...
public class GlobalVisionPositionEstimateMessage extends MavlinkMessage {
  private long usec;
  private float x;
  private float y;
  private float z;
  ...
  public GlobalVisionPositionEstimateMessage(int sequence, int systemId, int componentId) {
  ...
  public int getExtraCRC() { return 102; }
  ...
  public String toString() {
    StringBuilder result = new StringBuilder("GLOBAL_VISION_POSITION_ESTIMATE");
    result.append(": ");
    result.append("usec=");
