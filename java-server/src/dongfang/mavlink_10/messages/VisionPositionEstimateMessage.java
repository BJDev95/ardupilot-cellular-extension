...
public class VisionPositionEstimateMessage extends MavlinkMessage {
  private long usec;
  private float x;
  private float y;
  private float z;
  ...
  public VisionPositionEstimateMessage(int sequence, int systemId, int componentId) {
  ...
  public int getExtraCRC() { return 158; }
  ...
  public String toString() {
    StringBuilder result = new StringBuilder("VISION_POSITION_ESTIMATE");
    result.append(": ");
    result.append("usec=");
